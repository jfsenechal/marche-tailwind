<template>
  ...
  >
    <i
      class="fa i-swimmer group-hover:i-swimmer-white h-8 w-8 bg-center bg-no-repeat text-2xl"
    ></i>
  </a>

  <a
    class="mx-1 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-700 text-white"
    href="#"
  >
    <i
      class="fa fa-twitte2r i-swimmer-white h-8 w-8 bg-center bg-no-repeat text-2xl"
    ></i>
  </a>
  <p></p>
  <a
  ...
  >
    <i
      class="fa i-swimmer-white h-fit w-fit bg-contain bg-center bg-no-repeat text-2xl"
    ></i>
  </a>
  ...
  <ul class="flex w-full max-w-lg justify-center pt-10">
    <li class="flex w-[20%] items-center justify-center text-center">
      <a href="#">
        <img
          ...
          alt="patrimoine"
        />
        <span class="mx-auto text-black">Patrimoine</span>
      </a>
    </li>
    <li
      class="relative m-0 flex w-full flex-shrink-0 flex-grow-0 basis-1/4 justify-center border-0 py-0 px-4 text-center align-baseline font-sans text-base font-light not-italic text-neutral-800"
      style="
