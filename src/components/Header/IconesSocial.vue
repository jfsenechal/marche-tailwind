...
<template>
  <div class="flex space-x-6">
    ...
    <a href="#" class="hover:text-cta-light" :class="color">
    ...
    <a href="#" class="hover:text-cta-light" :class="color">
      ...
      <svg class="icon icon-tabler icon-tabler-brand-twitter" width="24" height="24" viewBox="0 0 24 24"
